 ...
 *
 * @param param0: SettingsModalProps
 * @returns settings modal for editing the user's profile
 */
export default function SettingsModal({
  ...
  const handleUpload = (result: unknown) => {
    ...
    if (uploadResult?.info?.secure_url) {
      setValue("image", uploadResult.info.secure_url, {
        shouldValidate: true,
      });
    }
  };
   ...
   *
   * @param data: new name and image of the user
   */
